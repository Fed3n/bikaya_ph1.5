...
La compilazione avviene con il comando 'scons TARGET', dove TARGET è uarm o umps / umps2. Per pulire i file per un target si aggiunge la flag -c ('scons TARGET -c').
